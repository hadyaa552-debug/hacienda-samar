...
const P="01080231288",PD="0108 023 1288",PI="+201080231288",WN="201080231288";
...
const WK="50f2c493-44ae-415d-8942-1195ac718d26";
...
function track(id:string){if(typeof window!=="undefined"&&(window as any).gtag)(window as any).gtag("event","cta_click",{cta_id:id,project:"hacienda_ras_el_hekma"});}
...
export default function Home(){
  ...
  async function sub(r:React.RefObject<HTMLFormElement|null>,ss:(s:any)=>void){
    ...
    const d=await res.json();if(d.success){ss("sent");r.current.reset();track("form_submit");}else throw 0;}catch{ss("error");}
  }
